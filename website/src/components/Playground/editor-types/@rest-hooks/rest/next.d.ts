...
interface ResourceEndpointExtensions<R extends Resource<any>, Get extends PartialRestGenerics = any, GetList extends PartialRestGenerics = any, Update extends PartialRestGenerics = any, PartialUpdate extends PartialRestGenerics = any, Create extends PartialRestGenerics = any, Delete extends PartialRestGenerics = any> {
    readonly get?: RestEndpointOptions<unknown extends Get ? R['get'] : OptionsToFunction<Get, R['get'], Extract<R['get'], FetchFunction>>, R['get']['schema']> & Readonly<Get>;
    readonly getList?: RestEndpointOptions<unknown extends GetList ? R['getList'] : OptionsToFunction<GetList, R['getList'], Extract<R['getList'], FetchFunction>>, R['getList']['schema']> & Readonly<GetList>;
    readonly update?: RestEndpointOptions<unknown extends Update ? R['update'] : OptionsToFunction<Update, R['update'], Extract<R['update'], FetchFunction>>, R['update']['schema']> & Readonly<Update>;
    readonly partialUpdate?: RestEndpointOptions<unknown extends PartialUpdate ? R['partialUpdate'] : OptionsToFunction<PartialUpdate, R['partialUpdate'], Extract<R['partialUpdate'], FetchFunction>>, R['partialUpdate']['schema']> & Readonly<PartialUpdate>;
    readonly create?: RestEndpointOptions<unknown extends Create ? R['create'] : OptionsToFunction<Create, R['create'], Extract<R['create'], FetchFunction>>, R['create']['schema']> & Readonly<Create>;
    readonly delete?: RestEndpointOptions<unknown extends Delete ? R['delete'] : OptionsToFunction<Delete, R['delete'], Extract<R['delete'], FetchFunction>>, R['delete']['schema']> & Readonly<Delete>;
}
type ExtendedResource<R extends Resource<any>, Get extends PartialRestGenerics | {} = any, GetList extends PartialRestGenerics | {} = any, Update extends PartialRestGenerics | {} = any, PartialUpdate extends PartialRestGenerics | {} = any, Create extends PartialRestGenerics | {} = any, Delete extends PartialRestGenerics | {} = any, E extends Record<string, PartialRestGenerics> = {}> = {
    ...
    create: unknown extends Create ? unknown extends GetList ? R['create'] : RestExtendedEndpoint<GetList, R['create']> : unknown extends GetList ? RestExtendedEndpoint<Create, R['create']> : RestExtendedEndpoint<Defaults<Create, GetList>, R['create']>;
 ...
 */
declare function createResource<const O extends ResourceGenerics, const Get extends PartialRestGenerics = any, const GetList extends PartialRestGenerics = any, const Update extends PartialRestGenerics = any, const PartialUpdate extends PartialRestGenerics = any, const Create extends PartialRestGenerics = any, const Delete extends PartialRestGenerics = any, const E extends Record<string, PartialRestGenerics & RestEndpointOptions> = {}>({ path, schema, Endpoint, optimistic, get: getOpt, getList: getListOpt, update: updateOpt, partialUpdate: partialOpt, delete: delOpt, create: createOpt, endpoints, ...extraOptions }: Readonly<O> & ResourceOptions & ResourceEndpointExtensions<Resource<O>, Get, GetList, Update, PartialUpdate, Create, Delete> & {
    endpoints?: E;
}): ExtendedResource<Resource<O>, Get, GetList, Update, PartialUpdate, Create, Delete, E>;
