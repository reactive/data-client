...
declare class GQLEndpoint<Variables, S extends Schema | undefined = Schema | undefined, M extends true | undefined = true | undefined> extends Endpoint<(v: Variables) => Promise<Denormalize<S>>, S, M> {
    ...
    process(value: any, variables: any): any;
    errorPolicy(error: any): "soft" | undefined;
    query<Q extends string | ((variables: any) => string), S extends Schema | undefined, E extends GQLEndpoint<any, any> = GQLEndpoint<any, any>>(this: E, queryOrGetQuery: Q, schema?: S): GQLEndpoint<Q extends (variables: infer V) => string ? V : any, S, undefined>;
    mutation<Q extends string | ((variables: any) => string), S extends Schema | undefined, E extends GQLEndpoint<any, any> = GQLEndpoint<any, any>>(this: E, queryOrGetQuery: Q, schema?: S): GQLEndpoint<Q extends (variables: infer V) => string ? V : any, S, undefined>;
}
