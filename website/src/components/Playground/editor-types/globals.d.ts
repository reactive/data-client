import {
  ...
  Controller,
  GCInterface,
  EndpointInterface as EndpointInterface$1,
  FetchFunction as FetchFunction$1,
  Schema as Schema$1,
  ResolveType as ResolveType$1,
  Denormalize as Denormalize$1,
  DenormalizeNullable as DenormalizeNullable$1,
  Queryable as Queryable$1,
  NI as NI$1,
  SchemaArgs as SchemaArgs$1,
  NetworkError as NetworkError$2,
  UnknownError as UnknownError$1,
  ErrorTypes as ErrorTypes$2,
...
type SchemaArgs<S extends Schema> =
  S extends (
    {
      createIfValid: any;
      pk: any;
...
type DenormalizeNullableNestedSchema<S extends NestedSchemaClass> =
  keyof S['schema'] extends never ? S['prototype']
...
type ResolveType<E extends (...args: any) => any> =
...
type EndpointToFunction<E extends (...args: any) => Promise<any>> = (
  this: E,
  ...args: Parameters<E>
) => ReturnType<E>;

type FetchFunction<A extends readonly any[] = any, R = any> = (
  ...args: A
) => Promise<R>;
 ...
 * @see https://dataclient.io/rest/api/EntityMixin
 */
declare function EntityMixin<TBase extends PKClass>(
  Base: TBase,
  opt?: EntityOptions<InstanceType<TBase>>,
): IEntityClass<TBase> & TBase;
declare function EntityMixin<TBase extends IDClass>(
  Base: TBase,
  opt?: EntityOptions<InstanceType<TBase>>,
): IEntityClass<TBase> & TBase & (new (...args: any[]) => IEntityInstance);
declare function EntityMixin<TBase extends Constructor>(
  Base: TBase,
 ...
 */
type LazySchemaArgs<S extends Schema> =
  S extends (
    {
      createIfValid: any;
      pk: any;
 ...
 * Conceptually only returns a single item
 */
type CollectionValuesAdder<S extends PolymorphicInterface> =
  S extends (
    {
 ...
 * Conceptually only returns a single item
 */
type CollectionArrayOrValuesAdder<S extends PolymorphicInterface> =
  S extends (
    {
      denormalize(...args: any): any;
      schema: infer T;
...
type CollectionFromSchema<
  ...
  Parent = any,
> = CollectionInterface<S extends any[] ? Array$1<S[number]> : S, Args, Parent>;
...
type SchemaFunction<K = string, Args = any> = (
  value: Args,
  parent: any,
  key: string,
) => K;
...
type schema_d_Collection<
  S extends any[] | PolymorphicInterface = any,
  Args extends any[] = DefaultArgs,
  Parent = any,
> = Collection<S, Args, Parent>;
declare const schema_d_Collection: typeof Collection;
type schema_d_CollectionArrayAdder<S extends PolymorphicInterface> =
  CollectionArrayAdder<S>;
type schema_d_CollectionArrayOrValuesAdder<S extends PolymorphicInterface> =
  CollectionArrayOrValuesAdder<S>;
type schema_d_CollectionConstructor = CollectionConstructor;
type schema_d_CollectionFromSchema<
  S extends any[] | PolymorphicInterface = any,
  Args extends any[] = DefaultArgs,
  Parent = any,
> = CollectionFromSchema<S, Args, Parent>;
type schema_d_CollectionInterface<
  S extends PolymorphicInterface = any,
  Args extends any[] = any[],
  Parent = any,
> = CollectionInterface<S, Args, Parent>;
declare const schema_d_CollectionRoot: typeof CollectionRoot;
type schema_d_CollectionValuesAdder<S extends PolymorphicInterface> =
  CollectionValuesAdder<S>;
...
declare namespace schema_d {
  export {
    ...
    type schema_d_CollectionArrayAdder as CollectionArrayAdder,
    type schema_d_CollectionArrayOrValuesAdder as CollectionArrayOrValuesAdder,
    type schema_d_CollectionConstructor as CollectionConstructor,
    type schema_d_CollectionFromSchema as CollectionFromSchema,
    type schema_d_CollectionInterface as CollectionInterface,
    schema_d_CollectionRoot as CollectionRoot,
    type schema_d_CollectionValuesAdder as CollectionValuesAdder,
    type schema_d_DefaultArgs as DefaultArgs,
    EntityMixin as Entity,
    type schema_d_EntityInterface as EntityInterface,
    type schema_d_EntityMap as EntityMap,
    schema_d_EntityMixin as EntityMixin,
    schema_d_Invalidate as Invalidate,
    schema_d_Lazy as Lazy,
    type schema_d_MergeFunction as MergeFunction,
    Object$1 as Object,
    schema_d_Query as Query,
    schema_d_Scalar as Scalar,
    type schema_d_SchemaAttributeFunction as SchemaAttributeFunction,
    type schema_d_SchemaClass as SchemaClass,
    type schema_d_SchemaFunction as SchemaFunction,
    type schema_d_StrategyFunction as StrategyFunction,
    schema_d_Union as Union,
    type schema_d_UnionConstructor as UnionConstructor,
    type schema_d_UnionInstance as UnionInstance,
    type schema_d_UnionResult as UnionResult,
    schema_d_UnionRoot as UnionRoot,
    schema_d_Values as Values,
    schema_d_unshift as unshift,
  };
}

declare const Entity_base: IEntityClass<
...
type ExtractCollection<S extends Schema | undefined> =
  S extends (
    {
      push: any;
      unshift: any;
    ...
    S
  : S extends Object$1<infer T> ? ExtractObject<T>
  : S extends (
    Exclude<
      Schema,
      {
...
type PathArgs<S extends string> =
  unknown extends S ? any
  : PathKeys<S> extends never ? unknown
...
type SoftPathArgs<P extends string> =
...
type PathArgsAndSearch<S extends string> =
  unknown extends S ? any
...
type ShortenPath<S extends string> =
  string extends S ? string
...
type OptionsToAdderBodyArgument<
  O extends {
    body?: any;
  },
  EntitySchema = any,
 ...
 */
interface RestEndpoint$1<O extends RestGenerics = any> extends RestInstance<
  RestFetch<
    unknown extends O ? any
    : 'searchParams' extends keyof O ?
      [O['searchParams']] extends [undefined] ?
...
interface RestEndpointConstructor {
  ...
  new <O extends RestGenerics = any>({
    ...
    Readonly<O> &
    ContentSchemaGuard<O>): RestEndpoint$1<O>;
...
type RestFetch<UrlParams, Body = {}, Resolve = any> = IfTypeScriptLooseNull<
...
type FetchMutate<A extends readonly any[] = [any, {}] | [{}], R = any> = (
  this: RestInstance,
  ...args: A
) => Promise<R>;
...
> = Omit<R, keyof T> & T;
interface ResourceEndpointExtensions<
  R extends ResourceInterface,
 ...
 * @see https://dataclient.io/rest/api/resource
 */
declare function resource<O extends ResourceGenerics>({
  path,
  schema,
  Endpoint,
  Collection,
 ...
 */
declare function hookifyResource<R extends {}>(
  resource: R,
 ...
 */
declare class ErrorBoundary<E extends Error> extends React.Component<
...
>(
  endpoint: E,
  ...args: readonly [...Parameters<E>]
): E['schema'] extends undefined | null ? ResolveType$1<E>
: Denormalize$1<E['schema']>;
declare function useSuspense<
  E extends EndpointInterface$1<
    FetchFunction$1,
    Schema$1 | undefined,
...
>(
  endpoint: E,
  ...args: readonly [...Parameters<E>] | readonly [null]
): E['schema'] extends undefined | null ? ResolveType$1<E> | undefined
: DenormalizeNullable$1<E['schema']>;
 ...
 */
declare function useQuery<S extends Queryable$1>(
  schema: S,
  ...args: NI$1<SchemaArgs$1<S>>
 ...
 */
declare function useError<E extends Pick<EndpointInterface$1, 'key'>>(
  endpoint: E,
  ...args: readonly [...Parameters<E['key']>] | readonly [null]
...
>(
  endpoint: E,
  ...args: readonly [...Parameters<E>]
): E['schema'] extends undefined | null ? UsablePromise<ResolveType$1<E>>
: UsablePromise<Denormalize$1<E['schema']>>;
declare function useFetch<
  E extends EndpointInterface$1<
    FetchFunction$1,
    Schema$1 | undefined,
...
>(
  ...
  UsablePromise<ResolveType$1<E> | undefined> | undefined
: UsablePromise<DenormalizeNullable$1<E['schema']>> | undefined;
...
export {
  ...
  Endpoint,
  type EndpointExtendOptions,
  type EndpointExtraOptions,
  type EndpointInstance,
  type EndpointInstanceInterface,
  ...
  type EntityPath,
  type EntityTable,
  type ErrorTypes$1 as ErrorTypes,
  type ExpiryStatusInterface,
  ExtendableEndpoint,
  type ExtendedResource,
  type FetchFunction,
  type FetchGet,
  ...
  type GetIndex,
  type HookResource,
  type HookableEndpointInterface,
  type IEntityClass,
  type IEntityInstance,
  type INormalizeDelegate,
  type IQueryDelegate,
  type RestEndpoint$1 as IRestEndpoint,
  type IndexPath,
  Invalidate,
  type KeyofEndpointInstance,
  type KeyofRestEndpoint,
  type KeysToArgs,
  Lazy,
  type Mergeable,
  type MethodToSide,
  ...
  type Normalize,
  type NormalizeNullable,
  type NormalizeObject,
  type NormalizedEntity,
  type NormalizedIndex,
  type NormalizedNullableObject,
  Object$1 as Object,
  type ObjectArgs,
  type OptionsToFunction,
  type PaginationEndpoint,
  type PaginationFieldEndpoint,
  type ParamFetchNoBody,
  type ParamFetchWithBody,
  type ParamToArgs,
  type PartialRestGenerics,
  type PathArgs,
  type PathArgsAndSearch,
  type PathKeys,
  type PolymorphicInterface,
  Query,
  type Queryable,
  type ReadEndpoint,
  type RecordClass,
  ...
  type ResolveType,
  type Resource,
  type ResourceEndpointExtensions,
  type ResourceExtension,
  type ResourceGenerics,
  type ResourceInterface,
  type ResourceOptions,
  RestEndpoint,
  type RestEndpointConstructor,
  type RestEndpointConstructorOptions,
  type RestEndpointExtendOptions,
  type RestEndpointOptions,
  type RestExtendedEndpoint,
  type RestFetch,
  type RestGenerics,
  type RestInstance,
  type RestInstanceBase,
  type RestType,
  type RestTypeNoBody,
  type RestTypeWithBody,
  Scalar,
