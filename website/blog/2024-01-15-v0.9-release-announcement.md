...
## Resource.extend() <small>(since 0.5)</small> {#resourceextend}
...
### controller.expireAll() <small>(since 0.3)</small> {#controllerexpireall}
...
### controller.fetchIfStale() <small>(since 0.4)</small> {#controllerfetchifstale}
...
### FormData argument filtering <small>(since 0.4)</small> {#formdataargumentfiltering}
...
### paginationField <small>(since 0.7)</small> {#paginationfield}
