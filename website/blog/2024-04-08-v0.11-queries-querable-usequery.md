...
These only improve the (up to 23x) [lead over the legacy normalizr](/docs/concepts/normalization#benchmarks) library.

```mermaid
xychart-beta
    title "Performance Improvements over v0.10"
...
[Benchmarks over time](https://reactive.github.io/data-client/dev/bench/)
