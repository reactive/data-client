...
- [10% faster normalization](/blog/2024/07/13/v0.14-release-announcement#normalization-performance)
...
### Schema interface changes (custom schemas only) {#schema-interface}

If you have custom schemas implementing `normalize()` or `denormalize()`, the interfaces have changed. [#3134](https://github.com/reactive/data-client/pull/3134)
