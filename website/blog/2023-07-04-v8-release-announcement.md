...
Upgrading is quite simple, as `@rest-hooks/rest/next` and `@rest-hooks/react/next` were introduced
...
For all details, [keep reading](/blog/2023/07/04/v8-release-announcement#rest-hooksreact-80):
