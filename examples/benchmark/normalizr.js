...
queryState.result = queryMemo.buildQueryKey(ProjectQuery, [], queryState);
const queryInfer = queryMemo.buildQueryKey(ProjectQuerySorted, [], queryState);
...
export default function addNormlizrSuite(suite) {
  ...
  return suite
    ...
    .add('infer All', () => {
      return new MemoCache().buildQueryKey(ProjectQuery, [], queryState);
    })
    .add('denormalizeLong', () => {
