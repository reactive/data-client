...
- Your advice may land after the implementer has moved on: state the assumptions your decision depends on, so they can be checked against the code as it now exists.
