...
export const createReceive: typeof __INTERNAL__.createReceive =
  __INTERNAL__.createReceive;
export const createReceiveError: typeof __INTERNAL__.createReceiveError =
...
export const inferResults: typeof __INTERNAL__.inferResults =
  __INTERNAL__.inferResults;
export const createReducer = __INTERNAL__.createReducer;
export const applyManager = __INTERNAL__.applyManager;
export const useCacheState = __INTERNAL__.useCacheState;
