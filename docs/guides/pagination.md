...
```typescript
import { Resource, SchemaMany, ReadShape, AbstractInstanceType } from 'rest-hooks';
...
export default class ArticleResource extends Resource {
  ...
  static listShape<T extends typeof Resource>(this: T): ReadShape<SchemaMany<AbstractInstanceType<T>>> {
    return {
      ...super.listShape(),
...
import { Resource, ReadShape, SchemaMany, AbstractInstanceType } from 'rest-hooks';
