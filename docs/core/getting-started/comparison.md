...
|                     |                                  [Rest Hooks](https://resthooks.io)                                   | [SWR](https://swr.vercel.app/) | [RTK-Query](https://redux-toolkit.js.org/rtk-query/overview) | [Apollo](https://www.apollographql.com/docs/react/) |
| ------------------- | :---------------------------------------------------------------------------------------------------: | :----------------------------: | :----------------------------------------------------------: | :-------------------------------------------------: |
| Fetch Protocols     |      [REST](/rest), [GraphQL](/graphql), [img+binary](../guides/img-media.md), user-defined[^1]       |        user-defined[^1]        |                    REST, user-defined[^1]                    |                       GraphQL                       |
| Push Protocols      | [Websockets](../api//Manager.md#data-stream), [SSE](../api//Manager.md#data-stream), user-defined[^1] |               🛑               |                 Websockets, user-defined[^1]                 |                GraphQL subscriptions                |
| Polling (hybrid)    |                                                  ✅                                                   |               🟡               |                              ✅                              |                         ✅                          |
| Offline persistence |                                          🟡 user-defined[^1]                                          |               🛑               |                     🟡 user-defined[^1]                      |                         ✅                          |
| View Library        |    React web, React Native, [NextJS](../guides/ssr#nextjs), [React SSR](../guides/ssr#express-js)     |           React web            |                      React web, Svelte                       |                      React web                      |
...
|                                               | Rest Hooks | SWR | RTK-Query | Apollo |
| --------------------------------------------- | :--------: | :-: | :-------: | :----: |
| **Data Integrity**                            |            |     |           |        |
| Typed returns                                 |     ✅     | 🛑  |    🛑     |        |
| Typed arguments                               |     ✅     | 🛑  |    🛑     |        |
...
| **Bundle size**              |            |                                                     |                                                                       |        |
| Auto code split              |     ✅     |                         ✅                          |                                  🛑                                   |   🛑   |
| Entry Bundle (gzip)          |   7.8kb    | [4.1kb](https://bundlephobia.com/package/swr@2.0.0) | [17kb](https://redux-toolkit.js.org/rtk-query/comparison#bundle-size) | 27.9kb |
