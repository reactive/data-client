...
Hooks read that state through `StateContext`. The Next.js App Router provider from
`@data-client/react/nextjs` fills this in from the stream; see the
[SSR guide](../guides/ssr.md#nextjs) for its props.
